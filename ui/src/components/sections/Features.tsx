...
const features = [
  {
    ...
    description: "Process patient data locally. Zero PHI exposure to cloud providers.",
    icon: (
  ...
  },
  {
    ...
    description: "Legal discovery on your machine. No subpoena risk for stored cloud data.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
