    ...
    <footer className="bg-zinc-950 border-t border-white/5 py-12 md:py-16">
      <div className="container px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              {/* Social Icons */}
              <a href="https://github.com/tomiwa-a" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors">
              ...
              <a href="https://twitter.com/tomiwa_amole" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-zinc-400">
              <li><a href="https://github.com/tomiwa-a" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors">GitHub</a></li>
              <li><a href="#" className="hover:text-rose-400 transition-colors">Discord</a></li>
              <li><a href="https://twitter.com/tomiwa_amole" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors">Twitter</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-zinc-600">
          <p>© 2026 Hippo Local AI. All rights reserved.</p>
